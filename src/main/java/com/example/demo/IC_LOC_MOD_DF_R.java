...
public class IC_LOC_MOD_DF_R {
	
	private String BILL_CYCLE_CODE,LOCATION_CODE,LOC_MOD_ID,PR_USER,PR_OFFICE_CODE,REMARKS,NEXT_USER;

	public IC_LOC_MOD_DF_R() {
		super();
		// TODO Auto-generated constructor stub
	}

	public IC_LOC_MOD_DF_R(String bILL_CYCLE_CODE, String lOCATION_CODE, String lOC_MOD_ID, String pR_USER,
			String pR_OFFICE_CODE, String rEMARKS, String nEXT_USER) {
		super();
	...
	public String toString() {
		return "IC_LOC_MOD_DF_R [BILL_CYCLE_CODE=" + BILL_CYCLE_CODE + ", LOCATION_CODE=" + LOCATION_CODE
				+ ", LOC_MOD_ID=" + LOC_MOD_ID + ", PR_USER=" + PR_USER + ", PR_OFFICE_CODE=" + PR_OFFICE_CODE
				+ ", REMARKS=" + REMARKS + ", NEXT_USER=" + NEXT_USER + "]";
	}
