...
public class IC_ES_STAT_BILL_COLL_REC_NESCO {
	
	@Override
	public String toString() {
		return "IC_ES_STAT_BILL_COLL_REC_NESCO [YRMON=" + YRMON + ", ENRGSALE=" + ENRGSALE + ", PFCSALE=" + PFCSALE
	...
	public IC_ES_STAT_BILL_COLL_REC_NESCO(String yRMON, String eNRGSALE, String pFCSALE, String tOTENRGSALE,
	...
	public IC_ES_STAT_BILL_COLL_REC_NESCO() {
		super();
